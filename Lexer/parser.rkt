...
(define myparser
 ...
 (exp     
          ...
          [(MUL32 REG NUMBER SEP REG NUMBER) (list 0 0 (string->symbol (format "r~a" $6)) (string->symbol (format "r~s" $3)) '(bpf-mul32 bpf-x bpf-alu))]
          [(MUL REG NUMBER SEP NUMBER) (list $5 0 'r0 (string->symbol (format "r~a" $3)) '(bpf-mul bpf-k bpf-alu))]
          [(MUL32 REG NUMBER SEP NUMBER) (list $5 0 'r0 (string->symbol (format "r~a" $3)) '(bpf-mul32 bpf-k bpf-alu))]
